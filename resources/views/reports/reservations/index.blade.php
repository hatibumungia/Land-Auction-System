                        ...
                        @if(count($all_plots_statuses) > 0)
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <ul class="pager">
                                        <li class="previous"><a
                                                    href="{{ $all_plots_statuses->previousPageUrl() }}">&larr;
                                                Previous</a></li>
                                        <li class="next"><a
                                                    href="{{ $all_plots_statuses->nextPageUrl() }}">Next &rarr;</a>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    Showing <strong>{{ $all_plots_statuses->count() }}</strong> of
                                    <strong>{{ $all_plots_statuses->total() }}</strong> reservations
                                </div>
                            </div>
