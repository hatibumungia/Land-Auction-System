                    ...
                    <div class="panel panel-default">
                        ...
                        <table class="table">
                            ...
                            @foreach($areas_locations as $areas_location)
                                <tr>
                                    <td><a title="Viwanja vilivyobaki {{ $areas_location->available_plots }}" href="/?eneo={{ $areas_location->areaname }}" class="list-group-item"
                    ...
                    <div class="panel panel-default">
                        ...
                        <table class="table">
                            ...
                            @foreach($areatypenames as  $areatypename)
                                ...
                                <tr>
                                    <td>
                                        <a title="Viwanja vilivyobaki {{ $areatypename->available_area_types_names }}" href="/?eneo={{ $_GET['eneo'] }}&matumizi-ya-ardhi={{ $areatypename->areatypename }}"
