...
@section('main_content')
    ...
    <div class="row">
        <div class="col-xs-12">
            <h2>All Land uses</h2>
            <a href="{{ url('/admin/land-uses/create') }}" class="btn btn-primary pull-right">New</a>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><strong>Total = </strong> {{ count($land_uses) }}</h3>
                </div>
                        ...
                        <table id="locationsTable" class="display" cellspacing="0" width="100%">
                            ...
                            @foreach($land_uses as $land_use)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/land-uses/{{ $land_use->areas_type_id }}">{{ $land_use->name }}</a>
                                    </td>
                                    ...
                                    <td><a data-toggle="tooltip" data-placement="right" title="Hariri"
                                           href="/admin/land-uses/{{ $land_use->areas_type_id }}/edit"><i
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p class="lead">Je, una uhakika kwamba unataka kufuta matumizi
                                                            ya ardhi ya
                ...
                <div class="panel-footer">
                    <strong>Total = </strong> {{ count($land_uses) }}
                </div>
            </div>
        </div>
    </div>
