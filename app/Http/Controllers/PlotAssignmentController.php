...
class PlotAssignmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('plot-assignments.index', compact('plot_assignments'));
    }
    ...
    public function create()
    {
        ...
        return view('plot-assignments.create', compact('areas', 'area_types', 'blocks'));
    }
    ...
    public function store(CreatePlotAssignmentRequest $request)
    {
        ...
        return redirect('plot-assignment');
