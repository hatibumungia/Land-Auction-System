$(document).ready(function () {
    ...
    $("#area_id").change(function () {
        ...
        var url = "/admin/ajax/PublishlocationAssignmentsGetLandUse";
    ...
    $("#block_assignment_area_id").change(function () {
        ...
        var url = "/admin/ajax/PublishblockAssignmentsGetLandUse";
        $.get(url, {area_id: area_id}, function (data, status) {
    ...
    $("#block_assignment_areas_type_id").change(function () {
        ...
        var url = "/admin/ajax/PublishblockAssignmentsGetBlock";
    ...
    $("#plot_assignment_area_id").on("change", function () {
        ...
        var url = "/admin/ajax/PublishplotAssignmentsGetLandUses";
    ...
    $("#plot_assignment_areas_type_id").on("change", function () {
        ...
        var url = "/admin/ajax/PublishplotAssignmentsGetBlock";
