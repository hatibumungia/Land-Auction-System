    ...
    blockListView.find('li').on('click', function () {
        ...
        $.get(url, {area_id: areaId, area_type_id: area_type_id, block_id: block_id}, function (data, status) {
            ...
            if(jsonData.length !== 0){
                ...
                html += "<div class='panel-heading'><h3 class='panel-title'>Viwanja</h3></div><ul class='list-group'><table id='plotDataTable' class='table table-hover display' cellspacing='0' width='100%'><thead><tr><th>Namba ya Kiwanja</th><th>Kitalu</th><th>Eneo</th><th>Ukubwa (Mita za Mraba)</th><th>Gharama (TZS)</th><th>Mahifadhi</th></tr></thead><tbody>";
